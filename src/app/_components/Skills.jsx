...
function Skills() {
	...
	return (
		<section
			...
			<h2 className='text-2xl font-medium text-center'>Skills</h2>

			<section className='flex justify-center gap-6 items-center'>
				<Button className='p-2' onClick={decreaseSkillPosition}>
					<MdArrowBackIosNew size='2rem' className='shrink-0' />
				</Button>

				<div
					className={`bg-primary-black text-primary-grey flex flex-col gap-6 w-40 h-40 py-3 my-10 border border-solid border-primary-grey items-center justify-center overflow-hidden transition-all duration-500 ${
				...
				<Button className='p-2' onClick={increaseSkillPosition}>
					<MdArrowForwardIos size='2rem' className='shrink-0' />
				</Button>
			</section>
